...
public class playScreen2 implements Screen {
    ...
    public playScreen2(MyGame game){
        this.game = game;
        game_camera=new OrthographicCamera();

        //image assets
        background_texture = new Texture(Gdx.files.internal("map_selection_menu_2.jpg"));
//        tank_image=new Texture(Gdx.files.internal("tank_image.png"));           //tank ka texture
    ...
    public void show() {
        ...
        Button button2 = new TextButton("WasteLands", mySkin, "default");
...
//                game.setScreen(new PlayScreen(game));
                game.setScreen(new Wastelands(game));
                return true;
